package com.appserba.data.local

import android.content.Context
import android.content.SharedPreferences
import com.appserba.data.model.ActionState
import com.appserba.data.model.AuthUser
import com.appserba.util.getObject
import com.appserba.util.putObjeck
...
class AuthPref(val context:Context) {
    ...
    var authUser: AuthUser?
        ...
        private set(value) = sp.edit().putObjeck(AUTH_USER, value).apply()
